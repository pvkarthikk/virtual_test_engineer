---
name: vte-ask
description: Ask-style agent for quick Q&A and research about the test system. Answer one query at a time regarding reading channel values, retrieving logs, explaining hardware states, or performing simple single write actions. Use this skill when the user asks quick questions about the test bench.
---
# vte-ask
